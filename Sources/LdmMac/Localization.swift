...
private let table: [String: [String: String]] = [
    ...
    "toast.douyinResolving":  ["zh-Hans": "正在解析抖音无水印地址…", "zh-Hant": "正在解析抖音無水印網址…",
                               "en": "Resolving the watermark-free Douyin URL…",
                               "ja": "Douyin のウォーターマークなし URL を解析中…",
                               "ko": "Douyin 워터마크 없는 URL 분석 중…"],
    "toast.douyinDone":       ["zh-Hans": "抖音已解析（无水印）：「%@」", "zh-Hant": "抖音已解析（無水印）：「%@」",
                               "en": "Douyin resolved (no watermark): “%@”",
                               "ja": "Douyin 解析完了（ウォーターマークなし）：「%@」",
                               "ko": "Douyin 분석 완료(워터마크 없음): “%@”"],
    "toast.douyinFailed":     ["zh-Hans": "抖音解析失败，改用视频解析兜底", "zh-Hant": "抖音解析失敗，改用影片解析備援",
                               "en": "Douyin resolve failed — falling back to the video extractor",
                               "ja": "Douyin の解析に失敗。動画解析にフォールバックします",
                               "ko": "Douyin 분석 실패 — 동영상 분석으로 대체합니다"],
